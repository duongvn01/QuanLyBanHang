...
namespace QuanLyTraHang
{
    public partial class UCTraHang : UserControl
    {
        ...
        public void TruyenTraHang_MaPhieuTra(TraHangO TH)
        {
            this.TH = TH;
        }
        void initObjectBUS()
        ...
        void LayTraHangByMaPhieuTra(TraHangO TH)
        {
            TH = traHangBUS.getOneTraHangByMaPhieuTra(TH);
        ...
        void LayChiTietPhieuTraHangByMaPhieuTra(TraHangO TH)
        {
            CTTH.MaPhieuTra = TH.MaPhieuTra;
                    ...
                    try
                    {
                        ...
                        if (f == true)
                        {
                            foreach (DataRow r in dt.Rows)
                            {
                                ...
                                CTTH.MaHangHoa = r[0].ToString();
                                CTTH.SoLuong = Convert.ToInt32(r[4]);
                                CTTH.DonGia = Convert.ToInt32(r[5]);
                                CTTH.ThanhTien = Convert.ToInt32(r[6]);
